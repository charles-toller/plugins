  ...
  public void onMethodCall(MethodCall call, Result result) {
    switch (call.method) {
      case METHOD_INIT:
        ...
        delegate.init(
            result, signInOption, requestedScopes, hostedDomain, clientId);
        break;
  ...
  public static class Delegate implements IDelegate, PluginRegistry.ActivityResultListener {
    ...
    public void init(
      ...
      try {
        ...
        // Requests with a clientId if one was provided manually. If one was not,
        // fallback to a google-services.json parsed by google-services.
